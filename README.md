...
### Call to GET genesis block

![genesis-block-get](./assets/get-genesis-block.png)

### Call to POST a request validation

![post-request-validation](./assets/post-request-validation.png)

### Sign a message with a wallet

![message-signature](./assets/message-signature.png)

### Submit a star with POST

![post-submit-star](./assets/post-submit-star.png)

### Retrieve all stars owned by an address with GET

![get-stars-by-address](./assets/get-stars-by-address.png)
